...
print(n) #se tiver conteudo dentro é true se nao é falso
N1 =  input('Digite um valor: ')
print(N1.isnumeric())#função pergunta se a variavel é um numero, diz se é possivel converter esse valor em um numero
